...
setup(
    ...
    description='A simple wrapper around pandoc to simplify conversion from markdown to other formats',
    ...
    keywords='markdown pandoc pdf word',

    # Using find_packages to find all subpackages in where. This is
